...
const ItemPage =(props) => {
    ...
    const Genres = ()=> genres.map(genre => (<div>{genre.name}</div>))

    // const {original_name,original_title, genre_ids, name, popularity, origin_country, vote_count, first_air_date, backdrop_path, original_language, id, vote_average, overview, poster_path, credits} = props.item;
